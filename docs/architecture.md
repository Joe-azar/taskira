...
Ce fichier conserve un point d'entrée stable vers l'arborescence d'architecture exigée par le référentiel.
...
- [Matrice par module](../MIGRATION_MATRIX.md)
- [Feuille de route des phases](migration-matrix.md)
- [Rapport cumulatif](../ENTERPRISE_MIGRATION_REPORT.md)
