...
| Observabilité | Terminé P9 : `X-Request-Id` (généré ou repris du client si sûr), MDC, `ProblemDetails.of(...)` (`requestId` sur toute erreur), logs structurés JSON en `prod` | Actuator/Micrometer/Prometheus/Grafana en P10. |
