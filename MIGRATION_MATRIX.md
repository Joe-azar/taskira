...
| Base de données | Terminé P6 : PostgreSQL 18.6, Flyway `V1`–`V6`, `ddl-auto=validate`; migration réelle par sauvegarde/restauration vérifiée (ADR-0017), ancien volume PostgreSQL 16 conservé intact | Toute évolution de schéma par `V7+`. |
