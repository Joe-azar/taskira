...
| Déploiement | Compose de développement; runtime production-like terminé et fusionné depuis P11 (`infra/docker-compose.prodlike.yml`, Nginx non-root, backend non-root, 3 réseaux, secrets requis, profil `observability` optionnel), vérifié par un smoke test Playwright réel contre la stack démarrée | Staging en P15. |
